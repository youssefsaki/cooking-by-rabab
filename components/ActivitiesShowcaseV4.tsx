...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    longDescription: 'Choose your dish — Tagine, Msemen, Couscous, or Rfissa — and learn to cook it the traditional way in an authentic village kitchen. Master aromatic spices, hands-on techniques, and family recipes passed down through generations.',
    image: '/experiences/tajine-masterclass.jpg',
    imageAlt: 'Moroccan cooking masterclass Taghazout — Tagine, Msemen, Couscous, or Rfissa in traditional village kitchen',
    duration: '3-4 hours',
    groupSize: '4-8 guests',
    highlights: ['Choice of Tagine, Msemen, Couscous, or Rfissa', 'Traditional techniques', 'Aromatic spice blends', 'Village kitchen experience'],
    featured: true,
