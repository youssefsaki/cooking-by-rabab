    ...
    <section className="py-0 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
        <div className="relative h-[400px] lg:h-auto">
          <Image
            src="/community/pet-support.webp"
        ...
        <div className="bg-gradient-to-br from-amber-500 to-orange-500 p-10 lg:p-16 flex flex-col justify-center">
          <div className="max-w-lg">
            ...
            <div className="space-y-3 mb-8">
              {community.impactItems.map((item) => (
            ...
            >
              ...
              <span>{community.bookGiveBack}</span>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            >
              ...
              <div className="p-6 sm:p-8">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">
                  {community.cats.badge}
                </p>
                <h3 className="text-2xl font-black text-gray-900 mb-3">{community.cats.title}</h3>
                <p className="text-gray-600 leading-relaxed">{community.cats.description}</p>
              </div>
            </article>
            ...
            >
              ...
              <div className="p-6 sm:p-8">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 mb-2">
                  {community.chickens.badge}
                </p>
                <h3 className="text-2xl font-black text-gray-900 mb-3">{community.chickens.title}</h3>
                <p className="text-gray-600 leading-relaxed">{community.chickens.description}</p>
              </div>
            </article>
          </div>
        </div>
