// Complete list of all countries with flags and dial codes
...
export const COUNTRIES: Country[] = [
  // Most common countries first for better performance
  ...
  { name: 'Saint Vincent', code: 'VC', dialCode: '+1784', flag: '🇻🇨' },
