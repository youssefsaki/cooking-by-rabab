...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="relative py-12 lg:py-16 overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50/30 to-yellow-50/20">
        {/* Animated Orange Water Circles Background */}
        <div className="absolute inset-0">
          {/* Large Orange Water Bubbles */}
          <div className="absolute top-1/4 left-1/5 w-32 h-32 bg-gradient-to-br from-orange-200/20 to-red-300/15 rounded-full animate-water-float-1 blur-sm"></div>
          ...
          <div className="absolute bottom-1/3 left-1/3 w-28 h-28 bg-gradient-to-br from-orange-200/20 to-red-300/15 rounded-full animate-water-float-3 blur-sm"></div>
          <div className="absolute bottom-1/4 right-1/5 w-20 h-20 bg-gradient-to-br from-orange-300/25 to-amber-200/20 rounded-full animate-water-float-4 blur-sm"></div>
          ...
          <div className="absolute top-2/3 right-1/6 w-14 h-14 bg-gradient-to-br from-orange-200/25 to-red-200/20 rounded-full animate-water-drift-2 blur-sm"></div>
          ...
          <div className="absolute bottom-2/3 right-1/3 w-12 h-12 bg-gradient-to-br from-orange-200/30 to-amber-200/25 rounded-full animate-water-drift-4 blur-sm"></div>
          ...
          <div className="absolute top-3/4 right-1/5 w-6 h-6 bg-gradient-to-br from-orange-300/30 to-red-200/25 rounded-full animate-water-bubble-2 blur-sm"></div>
          ...
          <div className="absolute bottom-3/4 right-1/2 w-7 h-7 bg-gradient-to-br from-orange-300/35 to-amber-200/30 rounded-full animate-water-bubble-4 blur-sm"></div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-12 text-center z-10">
          ...
          <div className="mb-10">
            <div className="inline-flex items-center justify-center relative">
              {/* Glowing Ring */}
              <div className="absolute w-32 h-32 bg-gradient-to-r from-orange-400/20 via-red-400/30 to-amber-400/20 rounded-full animate-pulse-glow blur-sm"></div>
          ...
          <div className="space-y-4">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 tracking-wide">
      ...
      <div className="relative py-12 lg:py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-orange-100 via-amber-50 to-yellow-100 animate-gradient-flow"></div>
        ...
        <div className="absolute inset-0">
          {/* Large Cozy Circles */}
          <div className="absolute top-1/4 left-1/6 w-40 h-40 bg-gradient-to-br from-orange-200/30 to-amber-200/20 rounded-full animate-cozy-float-1 blur-md"></div>
          ...
          <div className="absolute bottom-1/4 right-1/6 w-28 h-28 bg-gradient-to-br from-orange-200/35 to-red-200/20 rounded-full animate-cozy-float-4 blur-md"></div>
          ...
          <div className="absolute top-2/3 right-1/8 w-20 h-20 bg-gradient-to-br from-orange-200/30 to-amber-200/35 rounded-full animate-cozy-drift-2 blur-sm"></div>
          ...
          <div className="absolute top-1/6 left-1/3 w-12 h-12 bg-gradient-to-br from-orange-300/50 to-amber-300/40 rounded-full animate-cozy-bubble-1 blur-sm"></div>
          ...
          <div className="absolute bottom-3/4 right-1/2 w-8 h-8 bg-gradient-to-br from-orange-300/55 to-red-300/35 rounded-full animate-cozy-bubble-4 blur-sm"></div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-12 text-center z-10">
          ...
          <div className="mb-12">
            <div className="inline-flex items-center justify-center relative">
              ...
              <div className="absolute w-48 h-48 bg-gradient-to-r from-orange-300/20 via-red-300/25 to-amber-300/20 rounded-full animate-cozy-glow-1 blur-lg"></div>
              ...
              {/* Main Cozy Icon */}
              <div className="relative w-20 h-20 bg-gradient-to-br from-white/95 to-orange-50/90 backdrop-blur-sm rounded-2xl flex items-center justify-center shadow-2xl border border-orange-200/50">
                <svg className="w-10 h-10 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Cozy Text Content */}
          <div className="space-y-4">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 tracking-wide leading-tight">
          ...
          <div className="mt-16 flex items-center justify-center space-x-8">
            ...
            <div className="w-4 h-4 bg-gradient-to-br from-orange-400 to-red-500 rounded-full animate-pulse"></div>
            ...
            <div className="w-4 h-4 bg-gradient-to-br from-orange-500 to-red-600 rounded-full animate-pulse" style={{ animationDelay: '0.8s' }}></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Modern Accommodation</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">All-Inclusive Packages</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Community Vibe</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-warm-white rounded-3xl p-10 lg:p-16 shadow-xl max-w-5xl mx-auto border border-warm-gray-200/50">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button
                  ...
                  className="px-10 py-5 bg-primary text-white font-bold uppercase tracking-wide rounded-xl hover:bg-primary-dark hover:shadow-lg hover:scale-105 transition-all duration-300"
                >
                  View Our Packages
                </button>
                <button
                  onClick={() => window.location.href = '/houseandrooms'}
                  className="px-10 py-5 bg-transparent border-2 border-primary text-primary font-bold uppercase tracking-wide rounded-xl hover:bg-primary hover:text-white hover:shadow-lg hover:scale-105 transition-all duration-300"
                >
                  Explore Our Rooms
                </button>
              </div>
